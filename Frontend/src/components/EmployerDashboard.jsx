...
export const EmployerDashboard = () => {
  ...
  const [jobForm, setJobForm] = useState({
    ...
    jobType: 'Full-Time',
    description: '',
    requirements: 'Good verbal communication\nCustomer-friendly attitude\nPunctuality and positive body language',
  ...
  const handleOpenJobModal = (jobToEdit = null) => {
    if (jobToEdit) {
      ...
      setJobForm({
        ...
        location: 'South Delhi (Sangam Vihar & Saket)',
        jobType: 'Full-Time',
        description: 'Engage with customers, present merchandise, communicate clearly, and support daily operations.',
        requirements: 'Good verbal communication\nCustomer-friendly attitude\nPunctuality and positive body language',
        requiredBadges: ['Active Communicator', 'Confidence Champion'],
        minConfidenceScore: 70,
        minAttendanceRate: 80,
